        ...
        <div className="flex h-[calc(100vh-200px)] border rounded-lg overflow-hidden">
          ...
          <div className="w-80 border-r flex flex-col">
            ...
            {filteredConversations.map((conv) => (
              <div
                key={conv.userId}
                className={`p-4 border-b hover:bg-gray-50 cursor-pointer flex items-center ${selectedConversation === conv.userId ? 'bg-blue-50' : ''
                  }`}
                  ...
                  {loadingMessages ? (
                    ...
                    <div className="space-y-4">
                      {messages.map((message) => (
                        ...
                        >
                          <div
                            className={`max-w-xs lg:max-w-md px-4 py-2 rounded-2xl shadow-sm ${message.sender_id === user?.id
                          ...
                          >
                            ...
                            <div className={`text-[10px] mt-1 ${message.sender_id === user?.id ? 'text-emerald-100' : 'text-gray-500'
                              }`}>
