    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-24 bg-slate-50 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <FadeIn direction="up">
            <h1 className="text-5xl font-bold text-slate-900 mb-6 tracking-tight">About Us</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-24">
            <FadeIn direction="up" delay={200}>
              <h2 className="text-3xl font-bold text-center text-slate-900 mb-12">Our Team & Activities</h2>
            </FadeIn>
              ...
              {teamPhotos.map((photo, index) => (
                <FadeIn key={index} delay={index * 100} direction="up">
                  <div className="group cursor-pointer">
                    <div className="relative overflow-hidden rounded-2xl shadow-md hover:shadow-xl transition-all duration-500 aspect-[4/3] mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-slate-900 text-center group-hover:text-blue-600 transition-colors">
                      {photo.title}
                    </h3>
                  </div>
                </FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
              <FadeIn direction="left" delay={200}>
                <div className="group text-center">
                  <div className="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 aspect-video mb-6">
                    <img
                      src={crewImg}
                      alt="Crew Fred Olsen"
                  ...
                  <h3 className="text-xl font-bold text-slate-900">Crew Fred Olsen</h3>
                </div>
              </FadeIn>
              ...
              <FadeIn direction="right" delay={200}>
                <div className="group text-center">
                  ...
                  <h3 className="text-xl font-bold text-slate-900">Ship Visit - Norwegian Jewel</h3>
                </div>
              </FadeIn>
            </div>
          </div>
          ...
          <FadeIn direction="up" delay={400}>
            <div className="max-w-4xl mx-auto bg-slate-50 rounded-3xl p-8 md:p-12 shadow-sm border border-slate-100">
              ...
              <div className="space-y-6 text-lg text-slate-600 leading-relaxed">
                <p>
                  The company is established in May 2000 as a representative office for <span className="font-semibold text-slate-900">Wilhelmsen Ship Management</span> formerly
                ...
                <p>
                  ...
                  was not part of their future plans. <span className="font-semibold text-slate-900">Cipta Wira Tirta</span> continues to serve the existing clients with similar quality of
                  services.
                </p>
                <p>
                  ...
                  The operations of PT. Cipta Wira Tirta is in Compliance with <span className="font-semibold text-slate-900">ISO 9001 : 2015</span>, <span className="font-semibold text-slate-900">MLC 2006</span> for SRPS and SIUJPAK.
                </p>
              </div>
            </div>
          </FadeIn>
